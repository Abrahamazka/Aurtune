...
<head>
    ...
    <title>Aurtune - Song Details</title>
...
<div class="mx-auto max-w-6xl bg-white">
    ...
    <section class="px-6 py-6">
        <p class="text-sm text-gray-500">
            ...
            <a href="/songs" class="hover:text-black transition-colors">Songs</a>
            <span class="mx-2">></span>
            <span class="text-black">Back to friends</span>
        </p>
    </section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            <div class="lg:col-span-4">
                <div class="overflow-hidden rounded-md bg-gray-200 shadow-sm">
                    <img src="{{ asset('/build/assets/back.jpg') }}" alt="Midnight Jazz Sessions Album Cover" class="w-full h-full object-cover">
                </div>
            </div>
            <div class="lg:col-span-8">
                <p class="text-sm text-gray-500 uppercase tracking-[0.3em]">Featured Song</p>
                <h1 class="text-5xl font-bold text-gray-900 mt-2">Back to friends</h1>
                <p class="text-gray-700 text-lg mt-4">by <a href="/artistdetails" class="font-semibold hover:text-blue-500 transition-colors">Sombr</a></p>
                <div class="flex flex-wrap gap-3 mt-5 text-gray-500">
                    <span class="rounded-md px-4 py-2 bg-gray-100">Alternative/Indie &bull; 4:18 &bull; 2024</span>
                </div>
    ...
    <section class="px-7 py-8 border-b border-gray-200">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 ">
            <div class="lg:col-span-2">
                <h2 class="text-2xl font-semibold">About the Song</h2>
                <p class="text-gray-600 mt-4 leading-relaxed">
                        “Back to Friends” by Sombr is a hauntingly introspective song about the emotional aftermath of an intimate connection that has been blurred by shifting boundaries. The lyrics explore the complex tension between physical intimacy and the struggle to return to a platonic friendship afterward. The song captures the vulnerability and confusion of trying to reconcile the deeper feelings that were once shared with the reality of emotional detachment.</p>
            </div>
            <div class="lg:col-span-1">
                <div class="rounded-md p-5 bg-gray-100 shadow-sm">
                    <h3 class="text-lg font-semibold text-center">Song Information</h3>
    ...
    <section class="px-6 py-8 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h2 class="text-2xl font-semibold">Tracklist from this album</h2>
                <p class="text-sm text-gray-500">1 track • 4 min</p>
            </div>

            <div class="mt-6 overflow-hidden rounded-md border border-gray-200">

                <div class="grid grid-cols-12 bg-gray-100 px-4 py-3 text-sm font-semibold text-gray-600">
                    <div class="col-span-1">#</div>
                    <div class="col-span-8">Title</div>
                    <div class="col-span-3 text-right">Duration</div>
                </div>

                <div class="grid grid-cols-12 bg-gray-100 items-center px-4 py-4 text-sm transition-colors border-t border-gray-150 ">
                    <div class="col-span-1 text-black font-bold ">1</div>
                     <div class="col-span-8">
                         <p class="font-semibold text-black">Back to friends</p>
                         <p class="text-xs text-gray-500 mt-1">Current track</p>
                     </div>
                    <div class="col-span-3 text-right text-gray-500">4:18</div>
                </div>
                <div class="grid grid-cols-12 items-center px-4 py-4 text-sm hover:bg-gray-100 transition-colors border-t border-gray-150 ">
                    <div class="col-span-1 text-black font-bold ">2</div>
                     <div class="col-span-8">
                         <p class="font-semibold text-black">Back to friends</p>
                     </div>
                    <div class="col-span-3 text-right text-gray-500">4:18</div>
                ...
                <div class="grid grid-cols-12 items-center px-4 py-4 text-sm hover:bg-gray-100 transition-colors border-t border-gray-150 ">
                    <div class="col-span-1 text-black font-bold ">3</div>
                     <div class="col-span-8">
                         <p class="font-semibold text-black">Back to friends</p>
                     </div>
                    <div class="col-span-3 text-right text-gray-500">4:18</div>
    ...
    <section class="px-6 py-8 border-b border-gray-200">
        <div class="flex items-center justify-between">
            ...
            <a href="/songs" class="text-sm text-blue-500 hover:text-blue-700 transition-colors">Explore more</a>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6 mb-8">
            <a href="#" class="border rounded-lg border-gray-200 p-5 hover:bg-gray-50 transition-colors">
                <p class="text-xs uppercase tracking-[0.3em] text-gray-500">Jazz</p>
                <h3 class="text-xl font-semibold mt-2">Sailor song</h3>
            ...
            <a href="#" class="border rounded-lg border-gray-200 p-5 hover:bg-gray-50 transition-colors">
                ...
                <h3 class="text-xl font-semibold mt-2">Black or white</h3>
                <p class="text-sm text-gray-600 mt-2">12 Albums &bull; 56 Tracks</p>
            </a>
            <a href="#" class="border rounded-lg border-gray-200 p-5 hover:bg-gray-50 transition-colors">
                <p class="text-xs uppercase tracking-[0.3em] text-gray-500">Rock</p>
                <h3 class="text-xl font-semibold mt-2">Numb</h3>
                <p class="text-sm text-gray-600 mt-2">12 Albums &bull; 56 Tracks</p>
            </a>
        </div>
    </section>
